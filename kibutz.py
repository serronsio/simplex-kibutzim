...
# Pedir o tamanho da área irrigável de cada kibutz
...
# Pedir a quantidade máxima de área que pode ser dedicada a cada plantação
...
# Pedir a quantidade de água alocada para a irrigação de cada kibutz
...
# Pedir os retornos líquidos esperados para cada plantação
